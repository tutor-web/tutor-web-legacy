...
a) Fleygboginn sker ekki $x$ ás

b) Fleygboginn sker $x$ ás einu sinni og það er í $x=0$. % CORRECT
...
c) $\mathbb{R}_+ = \{ x \in \mathbb{R} ; x>0\}$. % CORRECT
...
a) $x = - \frac{1}{2} \sqrt{85} + \frac{9}{2}$, og $x=\frac{9}{2} + \frac{1}{2} \sqrt{85}$. % CORRECT
